...
(() => {
  ...
  function pictureSelection() {
    ...
    function changePicture(event) {
      ...
      const imageAll = document.querySelectorAll('.preview-image')
      console.log(imageAll)
      for(let item of imageAll){
        let hasClass = item.classList.contains("js-choose-image")
        if(hasClass){
          item.classList.remove("js-choose-image")
        }
      }
