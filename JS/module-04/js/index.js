...
const products = {
  ...
  */
  ...
  function Cashier(name, productDatabase) {
    ...
    this.getCustomerMoney=function(number){
      this.customerMoney += number;
      return this.customerMoney 
    }
    this.countTotalPrice=function(order){
      this.tot=0
      for(let prod in order){
       this.tot += order[prod]*this.productDatabase[prod]
      }
      return this.tot
    }
    this.countChange= function(totalPrice){
      if(this.customerMoney>=this.tot){
        totalPrice = this.customerMoney - this.tot
