  ...
  g.prototype = {
    init: function() {
      ...
      c(this.element).each(function() {
        var a = c(this),
          d =
            a.css("max-height").replace(/[^-\d\.]/g, "") > a.data("max-height")
              ? a.css("max-height").replace(/[^-\d\.]/g, "")
              : a.data("max-height"),
          e = a.data("height-margin");
        "none" != a.css("max-height") && a.css("max-height", "none");
        b.setBoxHeight(a);
        if (a.outerHeight(!0) <= d + e) return !0;
        a.addClass("readmore-js-section " + b.options.collapsedClass).data(
          "collapsedHeight",
          d
        );
        a.after(
    ...
    toggleSlider: function(b, a, d) {
      ...
      c(a).height() <= d
        ? ((d = c(a).data("expandedHeight") + "px"),
          (newLink = "lessLink"),
          (f = !0),
          (sectionClass = e.options.expandedClass))
        : ((newLink = "moreLink"), (sectionClass = e.options.collapsedClass));
      ...
      c(a).animate(
        { height: d },
        {
          ...
          complete: function() {
            ...
            c(this)
              .removeClass(
                e.options.collapsedClass + " " + e.options.expandedClass
              )
    ...
    setBoxHeight: function(b) {
      var a = b
          .clone()
          .css({ height: "auto", width: b.width(), overflow: "hidden" })
          .insertAfter(b),
        c = a.outerHeight(!0);
      a.remove();
    ...
    resizeBoxes: function() {
      ...
      c(".readmore-js-section").each(function() {
        var a = c(this);
        b.setBoxHeight(a);
        (a.height() > a.data("expandedHeight") ||
          (a.hasClass(b.options.expandedClass) &&
            a.height() < a.data("expandedHeight"))) &&
          a.css("height", a.data("expandedHeight"));
      });
    },
    destroy: function() {
      var b = this;
      c(this.element).each(function() {
        ...
        a.removeClass(
          "readmore-js-section " +
            b.options.collapsedClass +
            " " +
            b.options.expandedClass
        )
  ...
  c.fn[f] = function(b) {
    ...
    if ("string" === typeof b && "_" !== b[0] && "init" !== b)
      return this.each(function() {
        ...
        d instanceof g &&
          "function" === typeof d[b] &&
          d[b].apply(d, Array.prototype.slice.call(a, 1));
      });
  };
})(jQuery);
